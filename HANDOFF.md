...
- **统计页柱形图优化**：最多显示10年，宽度自适应，点击跳转带类型参数
...
### 2026-05-14 v1.1.2 统计页今年数据只显示已看
- ✅ dashboard.html: 今年数据只统计已看状态
- ✅ dashboard.html: 点击今年跳转带上已看状态筛选

### 2026-05-14 v1.1.1 统计页修复与柱形图优化
- ✅ dashboard.html: 修复点击状态/年度数据时未传递类型参数的问题
- ✅ dashboard.html: 修复记录总数跳转未带类型参数的问题
- ✅ dashboard.html: 柱形图最多显示10个年度数据，超出显示"近10年"提示
- ✅ dashboard.html: 柱形图宽度自适应，均匀分布不留白
- ✅ dashboard.html: 年度文字根据柱宽动态调整大小
- ❌ Tauri 双模式兼容：尝试实现后回退（dialog 插件网络问题 + 复杂度太高）
